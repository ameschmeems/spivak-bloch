...
\begin{enumerate}
	\item[2.] $(a + b) + c = a + (b + c)$
	\begin{proof}
		Let \[G = \left\{z\in \N: \text{ if } x,y \in \N \text{ and } (x + y) + z = x + (y + z)\right\}.\]
	...
	\item[3.] $1 + a = s(a) = a + 1$.
	\begin{proof}
		It follows from the definition of +, that $a + 1 = s(a)$. Let $G = \left\{a \in N: 1 + a = s(a)\right\}$. $1 + 1 = s(1)$, so $1 \in G$. Now, let $a \in G$. Then $(1 + a) + 1 = s(1 + a) = 1 + s(a) = 1 + (1 + a)$. So $a \in G$, and therefore $G = \N$.
	\end{proof}
	\item[4.] $a + b = b + a$
\end{enumerate}
